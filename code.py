...
accuracy= accuracy_score(y_pred_bag,y_test)
print(accuracy)
...
voting_clf_soft= VotingClassifier(estimators = [('Logistic Regression', lr), ('Random forest classifier', rf), ('naive bayes', nv)], voting = 'soft')

voting_clf_soft.fit(X_train,y_train)
y_pred_soft= voting_clf_soft.predict(X_test)
accuracy_soft= accuracy_score(y_pred_soft,y_test)
print(accuracy_soft)
